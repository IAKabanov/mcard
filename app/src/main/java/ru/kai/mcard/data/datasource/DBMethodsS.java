...
import ru.kai.mcard.MAnalisisVisitAnaliseslistFragment;
import ru.kai.mcard.MVisitCuresFragment;
import ru.kai.mcard.MVisitDirectionsFragment;
import ru.kai.mcard.MVisitRecommendationsFragment;
import ru.kai.mcard.ModelVisitsCures;
import ru.kai.mcard.R;   //  УБРАТЬ !!!!!!!!!!!!!!!!!
import ru.kai.mcard.data.entity.SpecializationEntity;

/**
 * Created by akabanov on 30.08.2017.
 * The new DB class - singleton class
 */

public final class DBMethodsS {
...
*/
    ...
    private static final String CREATE_DB_TABLE_CLINIKS = "create table " + DBContract.DB_TABLE_CLINICS + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableClinics.COLUMN_CLINICS_NAME + " text not null, "
            + DBContract.TableClinics.COLUMN_CLINICS_DESCR + " text" + ");";
    // запрос на создание таблицы "cures"
    private static final String CREATE_DB_TABLE_CURES = "create table " + DBContract.DB_TABLE_CURES + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableCures.COLUMN_CURES_NAME + " text not null, "
            + DBContract.TableCures.COLUMN_CURES_DESCR + " text" + ");";
    // запрос на создание таблицы "recommendations"
    private static final String CREATE_DB_TABLE_RECOMMENDATIONS = "create table " + DBContract.DB_TABLE_RECOMMENDATIONS + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableRecommendations.COLUMN_RECOMMENDATIONS_NAME + " text not null" + ");";
    // запрос на создание таблицы "specializations"
    private static final String CREATE_DB_TABLE_SPECIALIZATIONS = "create table " + DBContract.DB_TABLE_SPECIALIZATIONS + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME + " text not null" + ");";
    // запрос на создание таблицы "doctors"
    private static final String CREATE_DB_TABLE_DOCTORS = "create table " + DBContract.DB_TABLE_DOCTORS + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableDoctors.COLUMN_DOCTORS_NAME + " text not null, "
            + DBContract.TableDoctors.COLUMN_DOCTORS_SPECIALIZATION_ID + " integer" + ");";  // id specializations
    // запрос на создание таблицы "visits"
    private static final String CREATE_DB_TABLE_VISITS = "create table " + DBContract.DB_TABLE_VISITS + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableVisits.COLUMN_VISITS_DATE_TIME + " long, "
            + DBContract.TableVisits.COLUMN_VISITS_CLINIC_ID + " integer, "
            + DBContract.TableVisits.COLUMN_VISITS_DOCTOR_ID + " integer, "
            + DBContract.TableVisits.COLUMN_VISITS_SPECIALIZATION_ID + " integer, "
            + DBContract.TableVisits.COLUMN_VISITS_COMMENT + " text, "
            + DBContract.TableVisits.COLUMN_VISITS_DIAGNOSIS_ID + " integer, "
            + DBContract.TableVisits.COLUMN_VISITS_REF_ID + " integer"
            //+ TableVisits.COLUMN_VISITS_CURES_ID + " integer"
            + ");";
    // запрос на создание таблицы "diagnoses"
    private static final String CREATE_DB_TABLE_DIAGNOSES = "create table " + DBContract.DB_TABLE_DIAGNOSES + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableDiagnoses.COLUMN_DIAGNOSES_NAME + " text not null" + ");";
    // запрос на создание таблицы "analises"
    private static final String CREATE_DB_TABLE_ANALISES_TYPES = "create table " + DBContract.DB_TABLE_ANALISES_TYPES + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableAnalisesTypes.COLUMN_ANALISES_TYPES_NAME + " text not null" + ");";
    // запрос на создание таблицы "visits_cures"
    private static final String CREATE_DB_TABLE_VISITS_CURES = "create table " + DBContract.DB_TABLE_VISITS_CURES + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableVisitsCures.COLUMN_BASIC_VISITS_ID + " integer, "
            + DBContract.TableVisitsCures.COLUMN_CURES_ID + " integer, "
            + DBContract.TableVisitsCures.COLUMN_CURES_DESCR + " text"
            + ");";
    // запрос на создание таблицы "visits_recommendations"
    private static final String CREATE_DB_TABLE_VISITS_RECOMMENDATIONS = "create table " + DBContract.DB_TABLE_VISITS_RECOMMENDATIONS + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableVisitsRecommendations.COLUMN_BASIC_VISITS_ID + " integer, "
            + DBContract.TableVisitsRecommendations.COLUMN_RECOMMENDATIONS_ID + " integer"
            + ");";
    ...
    private static final String CREATE_DB_TABLE_VISITS_DIRECTIONS = "create table " + DBContract.DB_TABLE_VISITS_DIRECTIONS + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableVisitsDirections.COLUMN_BASIC_VISITS_ID + " integer,"
            + DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_TYPE + " integer,"
            + DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_ID + " integer"
            + ");";
    // запрос на создание таблицы "visits_photos"
    private static final String CREATE_DB_TABLE_VISITS_PHOTOS = "create table " + DBContract.DB_TABLE_VISITS_PHOTOS + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_TYPE + " integer not null, "
            + DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_ID + " integer not null, "
            + DBContract.TableVisitsPhotos.COLUMN_PHOTOS_TYPE + " integer not null, "
            + DBContract.TableVisitsPhotos.COLUMN_PHOTOS_NAME + " text not null, "
            + DBContract.TableVisitsPhotos.COLUMN_PHOTOS_URI + " text not null"
            + ");";
    // запрос на создание таблицы "analises_visits"
    private static final String CREATE_DB_TABLE_ANALISES_VISITS = "create table " + DBContract.DB_TABLE_ANALISES_VISITS + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_DATE_TIME + " long, "
            + DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_CLINIC_ID + " integer, "
            + DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_ANALISES_TYPES_ID + " integer, "
            + DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_COMMENT + " text, "
            + DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_REF_ID + " integer"
            + ");";
    // запрос на создание таблицы "analises_visits_analises_list"  - табличная часть документа визит-исследование
    private static final String CREATE_DB_TABLE_ANALISES_VISITS_ANALISES_LIST = "create table if not exists " + DBContract.DB_TABLE_ANALISES_VISITS_ANALISES_LIST + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableAnalisisVisitsAnalisesList.COLUMN_BASIC_ANALISES_VISITS_ID + " integer,"
            + DBContract.TableAnalisisVisitsAnalisesList.COLUMN_ANALISIS_TYPES_ID + " integer,"
            + DBContract.TableAnalisisVisitsAnalisesList.COLUMN_REFERENCES_VISITS_ID + " integer"
            + ");";
    // запрос на создание таблицы "filters"
    private static final String CREATE_DB_TABLE_FILTERS = "create table " + DBContract.DB_TABLE_FILTERS + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableFilters.COLUMN_FILTERS_NAME + " text, "
            + DBContract.TableFilters.COLUMN_FILTERS_ONLY_WHITH_DATE + " integer, " //   0 или 1
            + DBContract.TableFilters.COLUMN_FILTERS_FIRST_DATE + " long, "
            + DBContract.TableFilters.COLUMN_FILTERS_LAST_DATE + " long, "
            + DBContract.TableFilters.COLUMN_FILTERS_CLINICS_ID + " integer, "
            + DBContract.TableFilters.COLUMN_FILTERS_DOCTORS_ID + " integer,"
            + DBContract.TableFilters.COLUMN_FILTERS_SPECIALIZATIONS_ID + " integer,"
            + DBContract.TableFilters.COLUMN_FILTERS_CURES_ID + " integer,"
            + DBContract.TableFilters.COLUMN_FILTERS_DIAGNOSIS_ID + " integer,"
            + DBContract.TableFilters.COLUMN_FILTERS_ANALISES_TYPES_ID + " integer,"
            + DBContract.TableFilters.COLUMN_FILTERS_RECOMMENDATIONS_ID+ " integer"
            + ");";
    // запрос на создание таблицы "profiles"
    private static final String CREATE_DB_TABLE_PROFILES = "create table " + DBContract.DB_TABLE_PROFILES + "("
            + BaseColumns._ID + " integer primary key autoincrement, "
            + DBContract.TableProfiles.COLUMN_PROFILES_NAME + " text, "
            + DBContract.TableProfiles.COLUMN_PROFILES_SEX + " text, "  // m/w
            + DBContract.TableProfiles.COLUMN_PROFILES_BIRTHDAY + " long, "
            + DBContract.TableProfiles.COLUMN_PROFILES_COMMENT+ " text"
            + ");";

    public static final int DATABASE_VERSION = Constants.DATABASE_VERSION;

/*
    private DBMethodsS(Context context){
...
/*
    // Singleton *****************
    private DBMethodsS(SQLiteDatabase db){
        this.db = db;
    }

    private static DBMethodsS inctance;

    public static synchronized DBMethodsS getInstance(SQLiteDatabase db){
        if(inctance == null){
            inctance = new DBMethodsS(db);
        }
        return inctance;
    }
    /*/
/****************************
*/
    public DBMethodsS(SQLiteDatabase db){
        this.db = db;
    }
    ...
    public Cursor getMainVisitList(){
        ...
        final String queryString = "" +
                ...
                "select " +
                "0 as type_of_visit, " +
                DBContract.TableVisits._ID + " as id, " +
                DBContract.TableVisits.COLUMN_VISITS_DATE_TIME + " as date, " +
                DBContract.TableVisits.COLUMN_VISITS_CLINIC_ID + " as clinicID, " +
                DBContract.TableVisits.COLUMN_VISITS_SPECIALIZATION_ID + " as specializationID ," +
                DBContract.TableVisits.COLUMN_VISITS_DOCTOR_ID + " as doctorID" +
                " from visits " +
                "union all " +
                "select " +
                "1 as type_of_visit, " +
                DBContract.TableAnalisesVisits._ID + " as id, " +
                DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_DATE_TIME + " as date, " +
                DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_CLINIC_ID + " as clinicID, " +
                DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_ANALISES_TYPES_ID + " as specializationID ," +
                " 0"+" as doctorID" +
        ...
        if (chosenFilterID != -1){ // т.е. фильтр выбран
            if (DATABASE_VERSION < 4) { // старый вариант БД - до 04.08.2016
                ...
                if (bundle != null) {
                    ...
                    if (mCuresID != 0) {
                        queryString = queryString + ", " + DBContract.TableVisitsCures.COLUMN_CURES_ID + " as curesID";
                    }
...
*/
                    ...
                    queryString = queryString + "where " + DBContract.TableVisits.COLUMN_VISITS_PROFILE_ID + " = " + currentProfilesID + " ";
                    ...
                    queryString = queryString + "where " + DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_PROFILE_ID + " = " + currentProfilesID + " ";
            ...
            if (DATABASE_VERSION < 4) {  // старый вариант до 04.08.2016
                queryString = queryString +
                        ...
                        DBContract.TableVisits.COLUMN_VISITS_DOCTOR_ID + " as doctorID" +
                        " from visits " +
                        "where " + DBContract.TableVisits.COLUMN_VISITS_PROFILE_ID + " = " + currentProfilesID + " " +
                        "union all " +
                        "select " +
                        "1 as type_of_visit, " +
                        ...
                        " 0"+" as doctorID" +
                        " from analises_visits " +
                        "where " + DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_PROFILE_ID + " = " + currentProfilesID + " ";
                if (order_down) {
                    queryString = queryString +
                            ") " +
                            "order by date ASC";
                ...
                try {
                    queryString = queryString +
                            ...
                            "(select " +
                            DBContract.TableAnalisisVisitsAnalisesList.COLUMN_ANALISIS_TYPES_ID + " " +
                            "from " +
                            DBContract.DB_TABLE_ANALISES_VISITS_ANALISES_LIST +
                            " where " +
...
//                    }
    ...
    private String getFiltredQueryStringWithAnalisisType(Bundle bundle, int currentProfilesID, boolean order_down){
        ...
        queryString = "" +
                ...
                " where " +
                " analises_visits._id = analises_visits_analises_list.basic_analisis_visits_id " +
                "and " + DBContract.TableAnalisisVisitsAnalisesList.COLUMN_ANALISIS_TYPES_ID + " = " + mAnalisesTypesID + " " +
    ...
    Cursor getAllVisits() {
        return db.query(DBContract.DB_TABLE_VISITS,
                new String[] {DBContract.TableVisits._ID,
                        DBContract.TableVisits.COLUMN_VISITS_DATE_TIME,
                        DBContract.TableVisits.COLUMN_VISITS_CLINIC_ID,
                        DBContract.TableVisits.COLUMN_VISITS_SPECIALIZATION_ID,
                        DBContract.TableVisits.COLUMN_VISITS_DOCTOR_ID},
    ...
    @NonNull
    public  List<SpecializationEntity> getAllSpecialisations() {
        List<SpecializationEntity> entityList = new ArrayList<>();

        Cursor cursor = db.query(DBContract.DB_TABLE_SPECIALIZATIONS,
                new String[] {DBContract.TableSpecializations._ID,
                        DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME},
        ...
        if (cursor.getCount()>0) {
            ...
            cursor.moveToFirst();
            do {
                entity = new SpecializationEntity(Integer.parseInt(cursor.getString(cursor.getColumnIndex(DBContract.TableSpecializations._ID))));
                entity.setName(cursor.getString(cursor.getColumnIndex(DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME)));
    ...
    @NonNull
    public SpecializationEntity getSpecializationByID(int specID) {
        SpecializationEntity entity = new SpecializationEntity(specID);
        Cursor cursor = db.query(DBContract.DB_TABLE_SPECIALIZATIONS, new String[] {DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME},
                "_id = ?", new String[]{String.valueOf((long) specID)}, null, null, null);


        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            //entity = new SpecializationEntity(specID);
            entity.setName(cursor.getString(cursor.getColumnIndex(DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME)));
            cursor.close();
        }
        return entity;
    ...
    public int insertSpecialization(SpecializationEntity entity) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME, entity.getName());
        return (int) db.insert(DBContract.DB_TABLE_SPECIALIZATIONS, null, newValue);
    }

    // uptade докторскую специализацию
    public int updateSpecialization(SpecializationEntity entity) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME, entity.getName());
        return (int) db.update(DBContract.DB_TABLE_SPECIALIZATIONS, newValue, "_id = ?", new String[]{Long.toString(entity.getSpecID())});
    }
    ...
    */
    // delete докторскую специализацию
    public int deleteSpecialization(SpecializationEntity entity) {
        return (int) db.delete(DBContract.DB_TABLE_SPECIALIZATIONS, "_id = ?", new String[]{Long.toString(entity.getSpecID())});
    }
    ...
    boolean checkOfUsageSpecialization(int specializationsID){
        ...
        Cursor cursor = db.query(DBContract.DB_TABLE_DOCTORS, new String[]
                        {DBContract.TableDoctors._ID,
                                DBContract.TableDoctors.COLUMN_DOCTORS_SPECIALIZATION_ID,},
        ...
        Cursor cursorV = db.query(DBContract.DB_TABLE_VISITS, new String[]
                        {DBContract.TableVisits._ID,
                                DBContract.TableVisits.COLUMN_VISITS_SPECIALIZATION_ID,},
    ...
    Cursor getAllClinics() {
        return db.query(DBContract.DB_TABLE_CLINICS,
                new String[] {DBContract.TableClinics._ID,
                        DBContract.TableClinics.COLUMN_CLINICS_NAME, DBContract.TableClinics.COLUMN_CLINICS_DESCR},
                null, null, null, null, "name ASC");
    }

    // возвращаем поля (реквизиты) клиники по ее ID
    Bundle getClinicsFildsByClinicsID(int clinicsID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_CLINICS,
                new String[] {DBContract.TableClinics._ID,
                        DBContract.TableClinics.COLUMN_CLINICS_NAME,
                        //TableClinics.COLUMN_CLINICS_PHONES,
                        DBContract.TableClinics.COLUMN_CLINICS_DESCR},
                "_id = ?", new String[]{String.valueOf(clinicsID)}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            Bundle bundle = new Bundle();
            String mClinicsName = cursor.getString(cursor.getColumnIndex(DBContract.TableClinics.COLUMN_CLINICS_NAME));
            ...
            String mClinicsDescr = cursor.getString(cursor.getColumnIndex(DBContract.TableClinics.COLUMN_CLINICS_DESCR));
    ...
    int getIDClinicsByName(String clinicName) {
        int clinicID;
        Cursor cursor = db.query(DBContract.DB_TABLE_CLINICS, new String[] {DBContract.TableClinics._ID},
                "name = ?", new String[]{clinicName}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            clinicID = cursor.getInt(cursor.getColumnIndex(DBContract.TableClinics._ID));
        }else {clinicID = 0;}
        cursor.close();
    ...
    String getClinicsNameByID(int clinicsID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_CLINICS, new String[] {DBContract.TableClinics._ID, DBContract.TableClinics.COLUMN_CLINICS_NAME},
                "_id = ?", new String[]{String.valueOf(clinicsID)}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            String clinicsName = cursor.getString(cursor.getColumnIndex(DBContract.TableClinics.COLUMN_CLINICS_NAME));
            cursor.close();
            return clinicsName;
        }else {
            return "";
    ...
    long insertClinic(String strName, String strAdress) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableClinics.COLUMN_CLINICS_NAME, strName);
        newValue.put(DBContract.TableClinics.COLUMN_CLINICS_DESCR, strAdress);
        return db.insert(DBContract.DB_TABLE_CLINICS, null, newValue);
    }

    // uptade clinic
    void updateClinic(int chooseID, String chooseName, String chooseAdress) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableClinics.COLUMN_CLINICS_NAME, chooseName);
        newValue.put(DBContract.TableClinics.COLUMN_CLINICS_DESCR, chooseAdress);
        db.update(DBContract.DB_TABLE_CLINICS, newValue, "_id = ?", new String[]{Integer.toString(chooseID)});
    }

    // delete clinic
    void deleteClinic(int choosenID) {
        db.delete(DBContract.DB_TABLE_CLINICS, "_id = ?", new String[]{Integer.toString(choosenID)});
    }
    ...
    boolean checkOfUsageClinic(int clinicsID){
        ...
        // сначала TableVisits
        Cursor cursor = db.query(DBContract.DB_TABLE_VISITS, new String[]
                        {DBContract.TableVisits._ID,
                                DBContract.TableVisits.COLUMN_VISITS_CLINIC_ID,},
        ...
        Cursor cursorAV = db.query(DBContract.DB_TABLE_ANALISES_VISITS, new String[]
                        {DBContract.TableAnalisesVisits._ID,
                                DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_CLINIC_ID,},
    ...
    Cursor getAllDoctors() {
        return db.query(DBContract.DB_TABLE_DOCTORS,
                new String[] {DBContract.TableDoctors._ID,
                        DBContract.TableDoctors.COLUMN_DOCTORS_NAME,
                        DBContract.TableDoctors.COLUMN_DOCTORS_SPECIALIZATION_ID},
                null, null, null, null, "name ASC");
    }
    ...
    int getIDDoctorsByName(String doctorName) {
        int doctorsID;
        Cursor cursor = db.query(DBContract.DB_TABLE_DOCTORS, new String[] {DBContract.TableDoctors._ID},
                "name = ?", new String[]{doctorName}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            doctorsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableDoctors._ID));
        }else doctorsID = 0;
        cursor.close();
    ...
    String getDoctorsNameByID(int doctorsID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_DOCTORS, new String[] {DBContract.TableDoctors.COLUMN_DOCTORS_NAME},
                "_id = ?", new String[]{String.valueOf(doctorsID)}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            String doctorsName = cursor.getString(cursor.getColumnIndex(DBContract.TableDoctors.COLUMN_DOCTORS_NAME));
            cursor.close();
            return doctorsName;
        }else {
            cursor.close();
    ...
    long insertDoctor(String strName, int choosenSpecializationsID) {
        ...
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableDoctors.COLUMN_DOCTORS_NAME, strName);
        newValue.put(DBContract.TableDoctors.COLUMN_DOCTORS_SPECIALIZATION_ID, item_id);
        return db.insert(DBContract.DB_TABLE_DOCTORS, null, newValue);
    }
    ...
    void updateDoctor(int choosenID, String choosenName, int choosenSpecializationsID) {
        ...
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableDoctors.COLUMN_DOCTORS_NAME, choosenName);
        newValue.put(DBContract.TableDoctors.COLUMN_DOCTORS_SPECIALIZATION_ID, item_id);
        db.update(DBContract.DB_TABLE_DOCTORS, newValue, "_id = ?", new String[]{Integer.toString(choosenID)});
    }

    // delete doctor
    void deleteDoctor(int choosenID) {
        db.delete(DBContract.DB_TABLE_DOCTORS, "_id = ?", new String[]{Long.toString(choosenID)});
    }
    ...
    int getDoctorsSpecializationIDByDoctorsID(int dsID){
        ...
        Cursor cursor = db.query(DBContract.DB_TABLE_DOCTORS,
                new String[]{DBContract.TableDoctors._ID, DBContract.TableDoctors.COLUMN_DOCTORS_SPECIALIZATION_ID},
                "_id = ?",
                new String[]{String.valueOf(dsID)},
                null, null, null);
        cursor.moveToFirst();
        int item_id = cursor.getInt(cursor.getColumnIndex(DBContract.TableDoctors.COLUMN_DOCTORS_SPECIALIZATION_ID));
        cursor.close();
        return item_id;
    ...
    String getDoctorsSpecializationByName(String dName){
        ...
        if (item_id != 0){
            ...
            cursor = db.query(DBContract.DB_TABLE_SPECIALIZATIONS,
                    new String[]{DBContract.TableSpecializations._ID, DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME},
                    "_id = ?",
                    new String[]{Long.toString(item_id)},
                    null, null, null);
            cursor.moveToFirst();
            String SpecializationName = cursor.getString(cursor.getColumnIndex(DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME));
            cursor.close();
    ...
    Cursor getAllCures() {
        return db.query(DBContract.DB_TABLE_CURES,
                new String[] {DBContract.TableCures._ID,
                        DBContract.TableCures.COLUMN_CURES_NAME,
                        DBContract.TableCures.COLUMN_CURES_DESCR},
                null, null, null, null, "name ASC");
    }

    // возвращаем поля (реквизиты) cure по его ID
    Bundle getCuresFildsByCuresID(int curesID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_CURES,
                new String[] {DBContract.TableCures._ID,
                        DBContract.TableCures.COLUMN_CURES_NAME,
                        DBContract.TableCures.COLUMN_CURES_DESCR},
        ...
        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            Bundle bundle = new Bundle();
            String curesName = cursor.getString(cursor.getColumnIndex(DBContract.TableCures.COLUMN_CURES_NAME));
            bundle.putString("curesName", curesName);
            String curesFeature = cursor.getString(cursor.getColumnIndex(DBContract.TableCures.COLUMN_CURES_DESCR));
    ...
    String getCuresNameByID(int curesID) {
        String curesName;
        Cursor cursor = db.query(DBContract.DB_TABLE_CURES, new String[]{DBContract.TableCures._ID, DBContract.TableCures.COLUMN_CURES_NAME},
                "_id = ?", new String[]{String.valueOf(curesID)}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            curesName = cursor.getString(cursor.getColumnIndex(DBContract.TableCures.COLUMN_CURES_NAME));
        }else {
            curesName = "";
        }
        cursor.close();
    ...
    String getCuresDescrByID(int curesID) {
        String curesDescr;
        Cursor cursor = db.query(DBContract.DB_TABLE_CURES, new String[]{DBContract.TableCures._ID, DBContract.TableCures.COLUMN_CURES_DESCR},
                "_id = ?", new String[]{String.valueOf(curesID)}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            curesDescr = cursor.getString(cursor.getColumnIndex(DBContract.TableCures.COLUMN_CURES_DESCR));
        }else {
            curesDescr = "";
        }
        cursor.close();
    ...
    int getIDCuresByName(String curesName) {
        int curesID;
        Cursor cursor = db.query(DBContract.DB_TABLE_CURES, new String[] {DBContract.TableCures._ID},
                "name = ?", new String[]{curesName}, null, null, null);

        if (cursor.getCount()>0){
            cursor.moveToFirst();
            curesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableCures._ID));
        }else curesID = 0;
        cursor.close();
    ...
    int insertCure(String strName, String strDescr) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableCures.COLUMN_CURES_NAME, strName);
        newValue.put(DBContract.TableCures.COLUMN_CURES_DESCR, strDescr);
        return (int) db.insert(DBContract.DB_TABLE_CURES, null, newValue);
    }

    // uptade назначение
    void updateCure(int choosenID, String choosenName, String choosenDescr) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableCures.COLUMN_CURES_NAME, choosenName);
        newValue.put(DBContract.TableCures.COLUMN_CURES_DESCR, choosenDescr);
        db.update(DBContract.DB_TABLE_CURES, newValue, "_id = ?", new String[]{Integer.toString(choosenID)});
    }

    // delete назначение
    void deleteCure(int choosenID) {
        db.delete(DBContract.DB_TABLE_CURES, "_id = ?", new String[]{Integer.toString(choosenID)});
        //db.rawQuery("delete from cures where _id = ?", null);
    }
    ...
    boolean checkOfUsageCure(int curesID){
        ...
        // Будем искать в визитах:
        Cursor cursor = db.query(DBContract.DB_TABLE_VISITS_CURES, new String[]
                        {DBContract.TableVisitsCures._ID,
                                DBContract.TableVisitsCures.COLUMN_CURES_ID,},
    ...
    Cursor getAllRecommendations() {
        return db.query(DBContract.DB_TABLE_RECOMMENDATIONS,
                new String[] {DBContract.TableRecommendations._ID,
                        DBContract.TableRecommendations.COLUMN_RECOMMENDATIONS_NAME},
                null, null, null, null, "name ASC");
    }
    ...
    String getRecommendationsNameByID(int recommendationsID) {
        ...
        Cursor cursor = db.query(DBContract.DB_TABLE_RECOMMENDATIONS, new String[] {DBContract.TableRecommendations._ID, DBContract.TableRecommendations.COLUMN_RECOMMENDATIONS_NAME},
                "_id = ?", new String[]{String.valueOf(recommendationsID)}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            recommendationsName = cursor.getString(cursor.getColumnIndex(DBContract.TableRecommendations.COLUMN_RECOMMENDATIONS_NAME));
        }else {
            recommendationsName = "";
        }
        cursor.close();
    ...
    private int getIDRecommendationsByName(String recommendationsName) {
        ...
        Cursor cursor = db.query(DBContract.DB_TABLE_RECOMMENDATIONS, new String[] {DBContract.TableRecommendations._ID},
                "name = ?", new String[]{recommendationsName}, null, null, null);

        if (cursor.getCount()>0){
            cursor.moveToFirst();
            recommendationsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableRecommendations._ID));
    ...
    int insertRecommendations(String recommendationsName) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableRecommendations.COLUMN_RECOMMENDATIONS_NAME, recommendationsName);
        return (int) db.insert(DBContract.DB_TABLE_RECOMMENDATIONS, null, newValue);
    }

    // uptade рекомендацию
    void updateRecommendations(int chosenID, String chosenName) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableRecommendations.COLUMN_RECOMMENDATIONS_NAME, chosenName);
        db.update(DBContract.DB_TABLE_RECOMMENDATIONS, newValue, "_id = ?", new String[]{Integer.toString(chosenID)});
    }

    // delete рекомендацию
    void deleteRecommendations(int chosenID) {
        db.delete(DBContract.DB_TABLE_RECOMMENDATIONS, "_id = ?", new String[]{String.valueOf(chosenID)});
    }
    ...
    Cursor getAllDiagnoses() {
        return db.query(DBContract.DB_TABLE_DIAGNOSES,
                new String[] {DBContract.TableDiagnoses._ID,
                        DBContract.TableDiagnoses.COLUMN_DIAGNOSES_NAME},
                null, null, null, null, "name ASC");
    }
    ...
    String getDiagnosesNameByID(int diagnosesID) {
        ...
        Cursor cursor = db.query(DBContract.DB_TABLE_DIAGNOSES, new String[] {DBContract.TableDiagnoses._ID, DBContract.TableDiagnoses.COLUMN_DIAGNOSES_NAME},
                "_id = ?", new String[]{String.valueOf(diagnosesID)}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            diagnosesName = cursor.getString(cursor.getColumnIndex(DBContract.TableDiagnoses.COLUMN_DIAGNOSES_NAME));
        }else {
            diagnosesName = "";
        }
        cursor.close();
    ...
    int getIDDiagnosesByName(String diagnosesName) {
        int diagnosesID;
        Cursor cursor = db.query(DBContract.DB_TABLE_DIAGNOSES, new String[] {DBContract.TableDiagnoses._ID},
                "name = ?", new String[]{diagnosesName}, null, null, null);

        if (cursor.getCount()>0){
            cursor.moveToFirst();
            diagnosesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableDiagnoses._ID));
        }else diagnosesID = 0;
        cursor.close();
    ...
    long insertDiagnoses(String strName) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableDiagnoses.COLUMN_DIAGNOSES_NAME, strName);
        return db.insert(DBContract.DB_TABLE_DIAGNOSES, null, newValue);
    }

    // uptade диагноз
    void updateDiagnoses(int choosenID, String choosenName) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableDiagnoses.COLUMN_DIAGNOSES_NAME, choosenName);
        db.update(DBContract.DB_TABLE_DIAGNOSES, newValue, "_id = ?", new String[]{Integer.toString(choosenID)});
    }

    // delete диагноз
    void deleteDiagnoses(int choosenID) {
        db.delete(DBContract.DB_TABLE_DIAGNOSES, "_id = ?", new String[]{String.valueOf(choosenID)});
    }
    ...
    boolean checkOfUsageDiagnosis(int diagnosisID){
        ...
        Cursor cursorV = db.query(DBContract.DB_TABLE_VISITS, new String[]
                        {DBContract.TableVisits._ID,
                                DBContract.TableVisits.COLUMN_VISITS_DIAGNOSIS_ID,},
    ...
    Cursor getAllAnalisesTypes() {
        return db.query(DBContract.DB_TABLE_ANALISES_TYPES,
                new String[] {DBContract.TableAnalisesTypes._ID,
                        DBContract.TableAnalisesTypes.COLUMN_ANALISES_TYPES_NAME},
                null, null, null, null, "name ASC");
    }
    ...
    String getAnalisesTypesNameByID(int analisesTypesID) {
        ...
        Cursor cursor = db.query(DBContract.DB_TABLE_ANALISES_TYPES, new String[] {DBContract.TableAnalisesTypes._ID, DBContract.TableAnalisesTypes.COLUMN_ANALISES_TYPES_NAME},
                "_id = ?", new String[]{String.valueOf(analisesTypesID)}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            analisesTypesName = cursor.getString(cursor.getColumnIndex(DBContract.TableAnalisesTypes.COLUMN_ANALISES_TYPES_NAME));
        }else {
            analisesTypesName = "";
        }
        cursor.close();
    ...
    int getIDAnalisesTypesByName(String analisesTypesName) {
        int analisesTypesID;
        Cursor cursor = db.query(DBContract.DB_TABLE_ANALISES_TYPES, new String[] {DBContract.TableAnalisesTypes._ID},
                "name = ?", new String[]{analisesTypesName}, null, null, null);

        if (cursor.getCount()>0){
            cursor.moveToFirst();
            analisesTypesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableAnalisesTypes._ID));
    ...
    int insertAnalisesType(String strName) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableAnalisesTypes.COLUMN_ANALISES_TYPES_NAME, strName);
        return (int) db.insert(DBContract.DB_TABLE_ANALISES_TYPES, null, newValue);
    }

    // uptade вид анализа
    void updateAnalisesType(int choosenID, String choosenName) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableAnalisesTypes.COLUMN_ANALISES_TYPES_NAME, choosenName);
        db.update(DBContract.DB_TABLE_ANALISES_TYPES, newValue, "_id = ?", new String[]{Integer.toString(choosenID)});
    }

    // delete вид анализа
    void deleteAnalisesType(int choosenID) {
        db.delete(DBContract.DB_TABLE_ANALISES_TYPES, "_id = ?", new String[]{String.valueOf(choosenID)});
    }
    ...
    boolean checkOfUsageAnalisisType(int analisisTypesID){
        ...
        Cursor cursor = db.query(DBContract.DB_TABLE_ANALISES_VISITS_ANALISES_LIST, new String[]
                        {DBContract.TableAnalisisVisitsAnalisesList._ID,
                                DBContract.TableAnalisisVisitsAnalisesList.COLUMN_BASIC_ANALISES_VISITS_ID,
                                DBContract.TableAnalisisVisitsAnalisesList.COLUMN_ANALISIS_TYPES_ID},
        ...
        Cursor cursorD = db.query(DBContract.DB_TABLE_VISITS_DIRECTIONS, new String[]
                        {DBContract.TableVisitsDirections._ID,
                                DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_TYPE,
                                DBContract.TableVisitsDirections.COLUMN_AN_TYPES_SPECIALISATIONS_ID},
    ...
    boolean hasDBClinic(String text){
        Cursor cursor =  db.query(DBContract.DB_TABLE_CLINICS, new String[] {DBContract.TableClinics._ID, DBContract.TableClinics.COLUMN_CLINICS_NAME, DBContract.TableClinics.COLUMN_CLINICS_DESCR},
    ...
    Cursor getFilteredClinics(String text) {
        if (text.length()==0){
            return db.query(DBContract.DB_TABLE_CLINICS, new String[] {DBContract.TableClinics._ID, DBContract.TableClinics.COLUMN_CLINICS_NAME, DBContract.TableClinics.COLUMN_CLINICS_DESCR},
                    null, null, null, null, "name ASC");
        }else {
            return db.query(DBContract.DB_TABLE_CLINICS, new String[] {DBContract.TableClinics._ID, DBContract.TableClinics.COLUMN_CLINICS_NAME, DBContract.TableClinics.COLUMN_CLINICS_DESCR},
    ...
    boolean hasDBDoctor(String text){
        Cursor cursor = db.query(DBContract.DB_TABLE_DOCTORS, new String[] {DBContract.TableDoctors._ID, DBContract.TableDoctors.COLUMN_DOCTORS_NAME},
                "name = ?", new String[]{text}, null, null, null);
        int cursorCount = cursor.getCount();
        cursor.close();
        return cursorCount != 0;
    ...
    Cursor getFilteredDoctors(String text) {
        if (text.length()==0){
            return db.query(DBContract.DB_TABLE_DOCTORS, new String[] {DBContract.TableDoctors._ID, DBContract.TableDoctors.COLUMN_DOCTORS_NAME},
                    null, null, null, null, "name ASC");
        }else {
            return db.query(DBContract.DB_TABLE_DOCTORS, new String[] {DBContract.TableDoctors._ID, DBContract.TableDoctors.COLUMN_DOCTORS_NAME},
                    "name Like ?", new String[]{"%"+text+"%"}, null, null, "name ASC");
    ...
    boolean hasDBSpecialization(String text){
        ...
        Cursor cursor = db.query(DBContract.DB_TABLE_SPECIALIZATIONS, new String[]{DBContract.TableSpecializations._ID, DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME},
                "name = ?", new String[]{text}, null, null, null);
        int cursorCount = cursor.getCount();
        cursor.close();
        return cursorCount != 0;
    ...
    Cursor getFilteredSpecialisations(String text) {
        if (text.length()==0){
            return db.query(DBContract.DB_TABLE_SPECIALIZATIONS,
                    new String[] {DBContract.TableSpecializations._ID,
                            DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME},
                    null, null, null, null, "name ASC");
        }else {
    ...
    Cursor getFilteredCures(String text) {
        if (text.length()==0){
            return db.query(DBContract.DB_TABLE_CURES, new String[] {DBContract.TableCures._ID, DBContract.TableCures.COLUMN_CURES_NAME},
                    null, null, null, null, "name ASC");
        }else {
            return db.query(DBContract.DB_TABLE_CURES, new String[] {DBContract.TableCures._ID, DBContract.TableCures.COLUMN_CURES_NAME},
                    "name Like ?", new String[]{"%"+text+"%"}, null, null, "name ASC");
    ...
    Cursor getFilteredDiagnoses(String text) {
        if (text.length()==0){
            return db.query(DBContract.DB_TABLE_DIAGNOSES, new String[] {DBContract.TableDiagnoses._ID, DBContract.TableDiagnoses.COLUMN_DIAGNOSES_NAME},
                    null, null, null, null, "name ASC");
        }else {
            return db.query(DBContract.DB_TABLE_DIAGNOSES, new String[] {DBContract.TableDiagnoses._ID, DBContract.TableDiagnoses.COLUMN_DIAGNOSES_NAME},
                    "name Like ?", new String[]{"%"+text+"%"}, null, null, "name ASC");
    ...
    Cursor getFilteredAnalisesTypes(String text) {
        if (text.length()==0){
            return db.query(DBContract.DB_TABLE_ANALISES_TYPES, new String[] {DBContract.TableAnalisesTypes._ID, DBContract.TableAnalisesTypes.COLUMN_ANALISES_TYPES_NAME},
                    null, null, null, null, "name ASC");
        }else {
            return db.query(DBContract.DB_TABLE_ANALISES_TYPES, new String[] {DBContract.TableAnalisesTypes._ID, DBContract.TableAnalisesTypes.COLUMN_ANALISES_TYPES_NAME},
                    "name Like ?", new String[]{"%"+text+"%"}, null, null, "name ASC");
    ...
    boolean hasDBFilter(String text){
        Cursor cursor =  db.query(DBContract.DB_TABLE_FILTERS, new String[] {DBContract.TableFilters._ID, DBContract.TableFilters.COLUMN_FILTERS_NAME},
                "name = ?", new String[]{text}, null, null, null);
        int cursorCount = cursor.getCount();
        cursor.close();
        return cursorCount != 0;
    ...
    void deleteVisit(int choosenID) {
        db.delete(DBContract.DB_TABLE_VISITS, "_id = ?", new String[]{String.valueOf(choosenID)});
    }
    ...
    long insertVisit(Bundle bundle){
        ...
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_DATE_TIME, bundle.getLong("mVisitsDateTime"));  // long
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_CLINIC_ID, bundle.getInt("clinicID")==0 ? null : bundle.getInt("clinicID"));  // integer
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_DOCTOR_ID, bundle.getInt("doctorID")==0 ? null : bundle.getInt("doctorID"));  // integer
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_SPECIALIZATION_ID, bundle.getInt("specializationID")==0 ? null : bundle.getInt("specializationID"));  // integer
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_COMMENT, bundle.getString("vComment"));  // text
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_DIAGNOSIS_ID, bundle.getInt("diagnosisID"));  // integer
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_REF_ID, bundle.getInt("referencesID") == 0 ? null : bundle.getInt("referencesID"));  // integer
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_PROFILE_ID, bundle.getInt("profileID") == 0 ? null : bundle.getInt("profileID"));  // integer

        return db.insert(DBContract.DB_TABLE_VISITS, null, newValue);
    ...
    void updateVisit(int choosenID, Bundle bundle){
        ...
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_DATE_TIME, mVisitsDateTime);  // long
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_CLINIC_ID, clinicID);  // integer
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_DOCTOR_ID, doctorID);  // integer
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_SPECIALIZATION_ID, specializationID);  // integer
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_COMMENT, vComment);  // text
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_DIAGNOSIS_ID, diagnosisID);  // integer
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_REF_ID, referencesID);  // integer
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_PROFILE_ID, profileID);  // integer

        db.update(DBContract.DB_TABLE_VISITS, newValue, "_id = ?", new String[]{String.valueOf(choosenID)});
    ...
    void updateVisitReferenceAndDiagnosis(int choosenID, int referencesID, int diagnosisID){
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_REF_ID, referencesID==0 ? null : referencesID);  // integer
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_DIAGNOSIS_ID, diagnosisID==0 ? null : diagnosisID);  // integer
    ...
    void updateVisitsProfile(int choosenID, int profilisID){
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableVisits.COLUMN_VISITS_PROFILE_ID, profilisID==0 ? null : profilisID);  // integer
    ...
    Bundle getVisitsFildsByVisitsID(int visitsID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_VISITS,
                new String[] {DBContract.TableVisits._ID,
                        DBContract.TableVisits.COLUMN_VISITS_DATE_TIME,
                        DBContract.TableVisits.COLUMN_VISITS_CLINIC_ID,
                        DBContract.TableVisits.COLUMN_VISITS_DOCTOR_ID,
                        DBContract.TableVisits.COLUMN_VISITS_SPECIALIZATION_ID,
                        DBContract.TableVisits.COLUMN_VISITS_COMMENT,
                        DBContract.TableVisits.COLUMN_VISITS_DIAGNOSIS_ID,
                        DBContract.TableVisits.COLUMN_VISITS_REF_ID,
                        DBContract.TableVisits.COLUMN_VISITS_PROFILE_ID},
        ...
        if (cursor.getCount()>0) {
            ...
            Long mVisitsDateTime = cursor.getLong(cursor.getColumnIndex(DBContract.TableVisits.COLUMN_VISITS_DATE_TIME));
            bundle.putLong("mVisitsDateTime", mVisitsDateTime);
            int clinicsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisits.COLUMN_VISITS_CLINIC_ID));
            bundle.putInt("clinicsID", clinicsID);
            int doctorsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisits.COLUMN_VISITS_DOCTOR_ID));
            bundle.putInt("doctorsID", doctorsID);
            int specializationsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisits.COLUMN_VISITS_SPECIALIZATION_ID));
            bundle.putInt("specializationsID", specializationsID);
            bundle.putString("vComment", cursor.getString(cursor.getColumnIndex(DBContract.TableVisits.COLUMN_VISITS_COMMENT)));

            int diagnosisID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisits.COLUMN_VISITS_DIAGNOSIS_ID));
            bundle.putInt("diagnosisID", diagnosisID);
            int referencesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisits.COLUMN_VISITS_REF_ID));
            bundle.putInt("referencesID", referencesID);
            int profileID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisits.COLUMN_VISITS_PROFILE_ID));
...
*/
    ...
    String checkOfUsageVisit(Context context, int visitsID){
        ...
        Cursor cursor = db.query(DBContract.DB_TABLE_VISITS_RECOMMENDATIONS, new String[]
                        {DBContract.TableVisitsRecommendations._ID,
                                DBContract.TableVisitsRecommendations.COLUMN_BASIC_VISITS_ID},
        ...
        Cursor cursorVC = db.query(DBContract.DB_TABLE_VISITS_CURES, new String[]
                        {DBContract.TableVisitsCures._ID,
                                DBContract.TableVisitsCures.COLUMN_BASIC_VISITS_ID},
                "visits_id = ?",
        ...
        Cursor cursorVD = db.query(DBContract.DB_TABLE_VISITS_DIRECTIONS, new String[]
                        {DBContract.TableVisitsDirections._ID,
                                DBContract.TableVisitsDirections.COLUMN_BASIC_VISITS_ID},
                "basic_visits_id = ?",
                new String[]{Integer.toString(visitsID)},
                null, null, null);
        ...
        Cursor cursorAVL = db.query(DBContract.DB_TABLE_ANALISES_VISITS_ANALISES_LIST, new String[]
                        {DBContract.TableAnalisisVisitsAnalisesList._ID,
                                DBContract.TableAnalisisVisitsAnalisesList.COLUMN_REFERENCES_VISITS_ID},
        ...
        Cursor cursorPh = db.query(DBContract.DB_TABLE_VISITS_PHOTOS, new String[]
                        {DBContract.TableVisitsPhotos._ID,
                                DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_TYPE,
                                DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_ID},
    ...
    void deleteVisitWithDependensesTablesFinely(int choosenVisitsID){
        ...
        if (cursorD.getCount()>0){
            cursorD.moveToFirst();
            do {
                int recordID = cursorD.getInt(cursorD.getColumnIndex(DBContract.TableVisitsDirections._ID));
                int directionsVisitsType = cursorD.getInt(cursorD.getColumnIndex(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_TYPE));
                int directionsVisitsID = cursorD.getInt(cursorD.getColumnIndex(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_ID));
                    ...
                    switch (directionsVisitsType){
                        ...
                        case Constants.DIRECTIONS_ANALISIS_TYPE_1:
                            ...
                            if (cursorDAVL.getCount()>0){
                                ...
                                do {
                                    int avlRecordID = cursorDAVL.getInt(cursorDAVL.getColumnIndex(DBContract.TableAnalisisVisitsAnalisesList._ID));
        ...
        Cursor cursorVC = db.query(DBContract.DB_TABLE_VISITS_CURES,
                new String[] {DBContract.TableVisitsCures._ID,
                        DBContract.TableVisitsCures.COLUMN_BASIC_VISITS_ID},
                "visits_id = ?",
        ...
        if (cursorVC.getCount() > 0){
            ...
            do {
                int recordID = cursorVC.getInt(cursorVC.getColumnIndex(DBContract.TableVisitsCures._ID));
        ...
        Cursor cursorR = db.query(DBContract.DB_TABLE_VISITS_RECOMMENDATIONS, new String[]
                        {DBContract.TableVisitsRecommendations._ID,
                                DBContract.TableVisitsRecommendations.COLUMN_BASIC_VISITS_ID},
        ...
        if (cursorR.getCount() > 0){
            cursorR.moveToFirst();
            do {
                int recordID = cursorR.getInt(cursorR.getColumnIndex(DBContract.TableVisitsRecommendations._ID));
        ...
        Cursor cursorPh = db.query(DBContract.DB_TABLE_VISITS_PHOTOS, new String[]
                        {DBContract.TableVisitsPhotos._ID,
                                DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_TYPE,
                                DBContract.TableVisitsPhotos.COLUMN_PHOTOS_TYPE,
                                DBContract.TableVisitsPhotos.COLUMN_PHOTOS_URI,
                                DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_ID},
                "basic_visits_type = ? and basic_visits_id = ?",
        ...
        if (cursorPh.getCount() > 0){
            ...
            do {
                int recordID = cursorPh.getInt(cursorPh.getColumnIndex(DBContract.TableVisitsPhotos._ID));
                int photosType = cursorPh.getInt(cursorPh.getColumnIndex(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_TYPE));
                String filePath = cursorPh.getString(cursorPh.getColumnIndex(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_URI));
        ...
        Cursor cursorVD = db.query(DBContract.DB_TABLE_VISITS_DIRECTIONS, new String[]
                        {DBContract.TableVisitsDirections._ID,
                                DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_TYPE,
                                DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_ID},
        ...
        if (cursorVD.getCount() > 0){
            ...
            do {
                int recordID = cursorVD.getInt(cursorVD.getColumnIndex(DBContract.TableVisitsDirections._ID));
                int basicVisitsID = cursorVD.getInt(cursorVD.getColumnIndex(DBContract.TableVisitsDirections.COLUMN_BASIC_VISITS_ID));
                int anTypesSpecID = cursorVD.getInt(cursorVD.getColumnIndex(DBContract.TableVisitsDirections.COLUMN_AN_TYPES_SPECIALISATIONS_ID));
    ...
    Cursor getAllVisitsCures(int visitsID) {
        return db.query(DBContract.DB_TABLE_VISITS_CURES,
                new String[]{DBContract.TableVisitsCures._ID,
                        DBContract.TableVisitsCures.COLUMN_CURES_ID,
                        DBContract.TableVisitsCures.COLUMN_CURES_DESCR},
    ...
    public Bundle getVisitsCuresFildsByVisitsCuresID(int visitsCuresID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_VISITS_CURES,
                new String[] {DBContract.TableVisitsCures._ID,
                        DBContract.TableVisitsCures.COLUMN_BASIC_VISITS_ID,
                        DBContract.TableVisitsCures.COLUMN_CURES_ID,
                        DBContract.TableVisitsCures.COLUMN_CURES_DESCR},
        ...
        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            Bundle bundle = new Bundle();
            int visitsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsCures.COLUMN_BASIC_VISITS_ID));
            bundle.putInt("visitsID", visitsID);
            int curesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsCures.COLUMN_CURES_ID));
            bundle.putInt("curesID", curesID);
            String visitsCuresDescr = cursor.getString(cursor.getColumnIndex(DBContract.TableVisitsCures.COLUMN_CURES_DESCR));
    ...
    private void insertVisitsCure(int visitsID, ArrayList<ModelVisitsCures> vcArrayList) {
        ...
        for (int i = 0; i < vcArrayList.size(); i++) {
            ...
            ContentValues newValue = new ContentValues();
            newValue.put(DBContract.TableVisitsCures.COLUMN_BASIC_VISITS_ID, visitsID);
            newValue.put(DBContract.TableVisitsCures.COLUMN_CURES_ID, curesID);
            newValue.put(DBContract.TableVisitsCures.COLUMN_CURES_DESCR, curesDescr);
            db.insert(DBContract.DB_TABLE_VISITS_CURES, null, newValue);
        }
    }
    ...
    public void updateVisitsCure(int visitsID, ArrayList<ModelVisitsCures> vcArrayList) {
        ...
        if (cursor.getCount()>0){
            cursor.moveToFirst();
            do {
                int currrentID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsCures._ID));
    ...
    public void deleteVisitsCure(int recordsID) {
        db.delete(DBContract.DB_TABLE_VISITS_CURES, "_id = ?", new String[]{Integer.toString(recordsID)});
    }
    ...
    public long insertRecordVisitsCuresList(int basicVisitsID, int visitsCuresID, String visitsCuresDescr, int curesExecutionsListsID) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableVisitsCures.COLUMN_BASIC_VISITS_ID, basicVisitsID);      // визит - основание, на котором выписали назначения
        newValue.put(DBContract.TableVisitsCures.COLUMN_CURES_ID, visitsCuresID);      // тип назначения
        newValue.put(DBContract.TableVisitsCures.COLUMN_CURES_DESCR, visitsCuresDescr);  // описание назначения
        ...
        return db.insert(DBContract.DB_TABLE_VISITS_CURES, null, newValue);
    ...
    void updateVisitsCuresList(int currentVisitsID, ArrayList<MVisitCuresFragment.VisitsCuresModel> vcArrayList) {
        ...
        if (cursor.getCount()>0){
            ...
            cursor.moveToFirst();
            do {
                currentID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsCures._ID));
    ...
    Cursor getAllVisitsRecommendations(int visitsID) {
        return db.query(DBContract.DB_TABLE_VISITS_RECOMMENDATIONS,
                new String[] {DBContract.TableVisitsRecommendations._ID,
                        DBContract.TableVisitsRecommendations.COLUMN_RECOMMENDATIONS_ID},
                "visits_id = ?", new String[]{String.valueOf(visitsID)}, null, null, null);
    }
    ...
    public Bundle getVisitsRecommendationsFildsByVisitsRecommendationsID(int visitsRecommendationsID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_VISITS_RECOMMENDATIONS,
                new String[] {DBContract.TableVisitsRecommendations._ID,
                        DBContract.TableVisitsRecommendations.COLUMN_BASIC_VISITS_ID,
                        DBContract.TableVisitsRecommendations.COLUMN_RECOMMENDATIONS_ID},
        ...
        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            Bundle bundle = new Bundle();
            int visitsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsRecommendations.COLUMN_BASIC_VISITS_ID));
            bundle.putInt("visitsID", visitsID);
            int recommendationsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsRecommendations.COLUMN_RECOMMENDATIONS_ID));
    ...
    public void insertVisitsRecommendations(int visitsID, ArrayList<ModelVisitsCures> vrArrayList) {
        ...
        for (int i = 0; i < vrArrayList.size(); i++) {
            ...
            ContentValues newValue = new ContentValues();
            newValue.put(DBContract.TableVisitsRecommendations.COLUMN_BASIC_VISITS_ID, visitsID);
            newValue.put(DBContract.TableVisitsRecommendations.COLUMN_RECOMMENDATIONS_ID, recommendationsID);
            db.insert(DBContract.DB_TABLE_VISITS_RECOMMENDATIONS, null, newValue);
        }
    }
    ...
    public void updateVisitsRecommendations(int visitsID, ArrayList<ModelVisitsCures> vrArrayList) {
        ...
        if (cursor.getCount()>0){
            cursor.moveToFirst();
            do {
                int currentID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsRecommendations._ID));
    ...
    public void deleteVisitsRecommendations(int recordsID) {
        db.delete(DBContract.DB_TABLE_VISITS_RECOMMENDATIONS, "_id = ?", new String[]{Integer.toString(recordsID)});
    }

    // insert new record (одна строка) в visits_cures_list
    public long insertRecordVisitsRecommendationsList(int basicVisitsID, int visitsRecommendationsID) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableVisitsRecommendations.COLUMN_BASIC_VISITS_ID, basicVisitsID);      // визит - основание, на котором выдали рекомендацию
        newValue.put(DBContract.TableVisitsRecommendations.COLUMN_RECOMMENDATIONS_ID, visitsRecommendationsID);      // id рекомендации
        return db.insert(DBContract.DB_TABLE_VISITS_RECOMMENDATIONS, null, newValue);
    ...
    void updateVisitsRecommendationsList(int currentVisitsID, ArrayList<MVisitRecommendationsFragment.VisitsRecommendationsModel> vrArrayList) {
        ...
        if (cursor.getCount()>0){
            ...
            cursor.moveToFirst();
            do {
                currentID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsRecommendations._ID));
                deleteVisitsRecommendations(currentID);
            }while (cursor.moveToNext());
        }
        cursor.close();
    ...
    public Cursor getAllVisitsDirections(int visitsID) {
        return db.query(DBContract.DB_TABLE_VISITS_DIRECTIONS,
                new String[] {DBContract.TableVisitsDirections._ID,
                        DBContract.TableVisitsDirections.COLUMN_BASIC_VISITS_ID,
                        DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_TYPE,
                        DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_ID},
    ...
    void updateRowVisitsDirections(int recordsID, int basicVisitsID, int directionsVisitsTypes, int anTypeOrSpecID, int directionsVisitsID){
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableVisitsDirections.COLUMN_BASIC_VISITS_ID, basicVisitsID);  // integer
        newValue.put(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_TYPE, directionsVisitsTypes);  // integer
        newValue.put(DBContract.TableVisitsDirections.COLUMN_AN_TYPES_SPECIALISATIONS_ID, anTypeOrSpecID);  // integer
        newValue.put(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_ID, directionsVisitsID);  // integer

        db.update(DBContract.DB_TABLE_VISITS_DIRECTIONS, newValue, "_id = ?", new String[]{String.valueOf(recordsID)});
    }
    ...
    Bundle getVisitsDirectionsFildsByVisitsDirectionsID(int directionsVisitsTypesID, int visitsDirectionsID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_VISITS_DIRECTIONS,
                new String[] {DBContract.TableVisitsDirections._ID,
                        DBContract.TableVisitsDirections.COLUMN_BASIC_VISITS_ID,
                        DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_TYPE,
                        DBContract.TableVisitsDirections.COLUMN_AN_TYPES_SPECIALISATIONS_ID,
        ...
        if (cursor.getCount()>0) {
            ...
            int basicVisitsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsDirections.COLUMN_BASIC_VISITS_ID));
            bundle.putInt("basicVisitsID", basicVisitsID);
            int directionVisitsTypesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_TYPE));
            bundle.putInt("directionVisitsTypesID", directionVisitsTypesID);
            int directionATorSpecID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsDirections.COLUMN_AN_TYPES_SPECIALISATIONS_ID));
            bundle.putInt("directionVisitsID", directionATorSpecID);
            int directionVisitsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_ID));
    ...
    public void insertVisitsDirection(int basicVisitsID, ArrayList<ModelVisitsCures> vdArrayList) {
        ...
        for (int i = 0; i < vdArrayList.size(); i++) {
            ...
            ContentValues newValue = new ContentValues();
            newValue.put(DBContract.TableVisitsDirections.COLUMN_BASIC_VISITS_ID, basicVisitsID);
            newValue.put(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_TYPE, directionVisitsTypesID);
            newValue.put(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_ID, directionVisitsID);
            db.insert(DBContract.DB_TABLE_VISITS_DIRECTIONS, null, newValue);
        }
    }
    ...
    public void insertRecordVisitsDirection(int currentVisitsID, int directionVisitsTypesID, int directionVisitsID) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableVisitsDirections.COLUMN_BASIC_VISITS_ID, currentVisitsID);      // визит - основание
        newValue.put(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_TYPE, directionVisitsTypesID);      // тип визита - направления
        ...
        newValue.put(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_ID, directionVisitsID);  // визит - направление, выданное на currentVisitsID
        db.insert(DBContract.DB_TABLE_VISITS_DIRECTIONS, null, newValue);
    ...
    public void updateVisitsDirection(int currentVisitsID, ArrayList<ModelVisitsCures> vdArrayList) {
        ...
        if (cursor.getCount()>0){
            ...
            cursor.moveToFirst();
            do {
                currentID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsDirections._ID));
    ...
    void deleteVisitsDirection(int recordsID) {
        db.delete(DBContract.DB_TABLE_VISITS_DIRECTIONS, "_id = ?", new String[]{Integer.toString(recordsID)});
    }
    ...
    long insertRecordVisitsDirectionsList(int basicVisitsID, int directionsVisitsType, int anTypeOrSpecID, int directionsVisitsID) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableVisitsDirections.COLUMN_BASIC_VISITS_ID, basicVisitsID);      // визит - основание, на котором выдали направление
        newValue.put(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_TYPE, directionsVisitsType);      // тип визита исследования (Constants.DIRECTIONS_ANALISIS_TYPE_1/Constants.DIRECTIONS_VISITS_TYPE_0)
        newValue.put(DBContract.TableVisitsDirections.COLUMN_AN_TYPES_SPECIALISATIONS_ID, anTypeOrSpecID);  // тип исследования или специализация доктора
        newValue.put(DBContract.TableVisitsDirections.COLUMN_DIRECTION_VISITS_ID, directionsVisitsID);  // визит, на котором будет это исследование или консультация доктора
        return db.insert(DBContract.DB_TABLE_VISITS_DIRECTIONS, null, newValue);
    ...
    Cursor getAllAnalisisVisits() {
        return db.query(DBContract.DB_TABLE_ANALISES_VISITS,
                new String[] {DBContract.TableAnalisesVisits._ID,
                        DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_DATE_TIME,
                        DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_CLINIC_ID,
                        DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_ANALISES_TYPES_ID,
                        DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_COMMENT,
                        DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_REF_ID,
                        DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_PROFILE_ID},
                null, null, null, null, "analisis_visits_date_time ASC");
    }

    void deleteAnalisisVisit(int chosenID) {
        db.delete(DBContract.DB_TABLE_ANALISES_VISITS, "_id = ?", new String[]{String.valueOf(chosenID)});
    }

    long insertAnalisisVisit(Bundle bundle){
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_DATE_TIME, bundle.getLong("mAnalisisVisitsMDateTime"));  // long
        newValue.put(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_CLINIC_ID, bundle.getInt("mClinicsID")==0 ? null : bundle.getInt("mClinicsID"));  // integer
        newValue.put(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_ANALISES_TYPES_ID, bundle.getInt("mAnalisisTypesID")==0 ? null : bundle.getInt("mAnalisisTypesID"));  // integer
        newValue.put(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_COMMENT, bundle.getString("mComment"));  // text
        newValue.put(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_REF_ID, bundle.getInt("mReferencesID") == 0 ? null : bundle.getInt("mReferencesID"));  // integer
        newValue.put(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_PROFILE_ID, bundle.getInt("mProfilisID") == 0 ? null : bundle.getInt("mProfilisID"));  // integer

        return db.insert(DBContract.DB_TABLE_ANALISES_VISITS, null, newValue);
    }
    ...
    void updateAnalisisVisit(int chosenID, Bundle bundle){
        ...
        newValue.put(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_COMMENT, bundle.getString("mComment"));  // text
        newValue.put(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_REF_ID, bundle.getInt("mReferencesID")==0 ? null : bundle.getInt("mReferencesID"));  // integer
        newValue.put(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_PROFILE_ID, bundle.getInt("mProfilisID")==-1 ? null : bundle.getInt("mProfilisID"));  // integer

        db.update(DBContract.DB_TABLE_ANALISES_VISITS, newValue, "_id = ?", new String[]{String.valueOf(chosenID)});
    }
    ...
    public void updateAnalisisVisitReference(int chosenID, int referencesID){
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_REF_ID, referencesID==0 ? null : referencesID);  // integer
    ...
    void updateAnalisisVisitsProfile(int choosenID, int profilisID){
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_PROFILE_ID, profilisID==0 ? null : profilisID);  // integer

        db.update(DBContract.DB_TABLE_ANALISES_VISITS, newValue, "_id = ?", new String[]{String.valueOf(choosenID)});
    }
    ...
    Bundle getAnalisisVisitsFildsByAnalisisVisitsID(int analisisVisitsID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_ANALISES_VISITS,
                new String[] {DBContract.TableVisits._ID,
                        DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_DATE_TIME,
                        DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_CLINIC_ID,
                        DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_ANALISES_TYPES_ID,
        ...
        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            Bundle bundle = new Bundle();
            Long mAnalisisVisitsDateTime = cursor.getLong(cursor.getColumnIndex(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_DATE_TIME));
            bundle.putLong("mAnalisisVisitsMDateTime", mAnalisisVisitsDateTime);
            int mClinicsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_CLINIC_ID));
            bundle.putInt("mClinicsID", mClinicsID);
            int mAnalisisTypesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_ANALISES_TYPES_ID));
            bundle.putInt("mAnalisisTypesID", mAnalisisTypesID);
            bundle.putString("mComment", cursor.getString(cursor.getColumnIndex(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_COMMENT)));
            int mReferencesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_REF_ID));
            bundle.putInt("mReferencesID", mReferencesID);
            int mProfilesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_PROFILE_ID));
            ...
            if (bundle == null)return "";
                ...
                if (DATABASE_VERSION > 3){
                    ...
                    if (cursor.getCount()>0){
                        cursor.moveToFirst();
                        do {
                            int rowID = cursor.getInt(cursor.getColumnIndex(DBContract.TableAnalisisVisitsAnalisesList._ID));
                            int analisisTypesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableAnalisisVisitsAnalisesList.COLUMN_ANALISIS_TYPES_ID));
    ...
    void deleteAnalisisVisitWithDependensesTablesFinely(int choosenAnalisisVisitsID){
        ...
        if (cursorAVL.getCount() > 0){
            ...
            do {
                int recordID = cursorAVL.getInt(cursorAVL.getColumnIndex(DBContract.TableAnalisisVisitsAnalisesList._ID));
    ...
    Cursor getAllAnalisisVisitsAnalisesList() {
        return db.query(DBContract.DB_TABLE_ANALISES_VISITS_ANALISES_LIST,
                new String[] {DBContract.TableAnalisisVisitsAnalisesList._ID}, null, null, null, null, null);
    }
    ...
    Cursor getAllAnalisisVisitsAnalisesList(int visitsID) {
        return db.query(DBContract.DB_TABLE_ANALISES_VISITS_ANALISES_LIST,
                new String[] {DBContract.TableAnalisisVisitsAnalisesList._ID,
                        DBContract.TableAnalisisVisitsAnalisesList.COLUMN_BASIC_ANALISES_VISITS_ID,
                        DBContract.TableAnalisisVisitsAnalisesList.COLUMN_ANALISIS_TYPES_ID,
                        DBContract.TableAnalisisVisitsAnalisesList.COLUMN_REFERENCES_VISITS_ID},
    ...
    public Bundle getAnalisisVisitsAnalisesListFildsByAnalisisVisitsAnalisesListID(int recordsID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_ANALISES_VISITS_ANALISES_LIST,
                new String[] {DBContract.TableAnalisisVisitsAnalisesList._ID,
                        DBContract.TableAnalisisVisitsAnalisesList.COLUMN_BASIC_ANALISES_VISITS_ID,
                        DBContract.TableAnalisisVisitsAnalisesList.COLUMN_ANALISIS_TYPES_ID,
                        DBContract.TableAnalisisVisitsAnalisesList.COLUMN_REFERENCES_VISITS_ID},
        ...
        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            Bundle bundle = new Bundle();
            int basicAnalisisVisitsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableAnalisisVisitsAnalisesList.COLUMN_BASIC_ANALISES_VISITS_ID));
            bundle.putInt("basicAnalisisVisitsID", basicAnalisisVisitsID);
            int analisisTypesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableAnalisisVisitsAnalisesList.COLUMN_ANALISIS_TYPES_ID));
            bundle.putInt("analisisVisitsTypesID", analisisTypesID);
            int referencesVisitsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableAnalisisVisitsAnalisesList.COLUMN_REFERENCES_VISITS_ID));
    ...
    long insertRecordAnalisisVisitsAnalisesList(int basicAnalisisVisitsID, int analisisTypesID, int referencesVisitsID) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableAnalisisVisitsAnalisesList.COLUMN_BASIC_ANALISES_VISITS_ID, basicAnalisisVisitsID);      // визит - основание
        newValue.put(DBContract.TableAnalisisVisitsAnalisesList.COLUMN_ANALISIS_TYPES_ID, analisisTypesID);      // тип исследования
        newValue.put(DBContract.TableAnalisisVisitsAnalisesList.COLUMN_REFERENCES_VISITS_ID, referencesVisitsID);  // визит, на котором направили на исследование
        return db.insert(DBContract.DB_TABLE_ANALISES_VISITS_ANALISES_LIST, null, newValue);
    ...
    void updateAnalisisVisitsAnalisesList(int currentAnalisisVisitsID, ArrayList<MAnalisisVisitAnaliseslistFragment.analisesTypesListModel> vdArrayList) {
        ...
        if (cursor.getCount()>0){
            ...
            cursor.moveToFirst();
            do {
                currentID = cursor.getInt(cursor.getColumnIndex(DBContract.TableAnalisisVisitsAnalisesList._ID));
    ...
    public void updateAnalisisVisitsAnalisesList(int recordID, int basicAnalisisVisitsID, int analisisTypesID, int referencesVisitsID){
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableAnalisisVisitsAnalisesList.COLUMN_BASIC_ANALISES_VISITS_ID, basicAnalisisVisitsID);
        newValue.put(DBContract.TableAnalisisVisitsAnalisesList.COLUMN_ANALISIS_TYPES_ID, analisisTypesID);
        newValue.put(DBContract.TableAnalisisVisitsAnalisesList.COLUMN_REFERENCES_VISITS_ID, referencesVisitsID);

        db.update(DBContract.DB_TABLE_ANALISES_VISITS_ANALISES_LIST, newValue, "_id = ?", new String[]{String.valueOf(recordID)});
    }
    ...
    void deleteAnalisisVisitsAnalisesList(int choosenID) {
        db.delete(DBContract.DB_TABLE_ANALISES_VISITS_ANALISES_LIST, "_id = ?", new String[]{Integer.toString(choosenID)});
    }
    ...
    Cursor getAllVisitsPhotos(int basicVisitsType, int basicVisitsID) {
        return db.query(DBContract.DB_TABLE_VISITS_PHOTOS,
                new String[] {DBContract.TableVisitsPhotos._ID,
                        DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_TYPE,
                        DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_ID,
                        DBContract.TableVisitsPhotos.COLUMN_PHOTOS_TYPE, // из камеры (0) или из галереи (1)
                        DBContract.TableVisitsPhotos.COLUMN_PHOTOS_NAME,
                        DBContract.TableVisitsPhotos.COLUMN_PHOTOS_URI},
                "basic_visits_type = ? and basic_visits_id = ?",
...
*/
    ...
    public Bundle getVisitsPhotosFildsByVisitsPhotosID(int visitsPhotosID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_VISITS_PHOTOS,
                new String[] {DBContract.TableVisitsPhotos._ID,
                        DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_TYPE,
                        DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_ID,
                        DBContract.TableVisitsPhotos.COLUMN_PHOTOS_TYPE,
        ...
        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            Bundle bundle = new Bundle();
            int basicVisitsType = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_TYPE));
            bundle.putInt("basicVisitsType", basicVisitsType);
            int basicVisitsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_ID));
            bundle.putInt("basicVisitsID", basicVisitsID);
            int visitsPhotosType = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_TYPE));
            bundle.putInt("visitsPhotosType", visitsPhotosType);
            String visitsPhotosName = cursor.getString(cursor.getColumnIndex(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_NAME));
            bundle.putString("visitsPhotosName", visitsPhotosName);
            String visitsPhotosURI = cursor.getString(cursor.getColumnIndex(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_URI));
    ...
    public void insertVisitsPhotos(int basicVisitsType, int basicVisitsID, ArrayList<ModelVisitsCures> vphArrayList) {
        ...
        for (int i = 0; i < vphArrayList.size(); i++) {
            ...
            ContentValues newValue = new ContentValues();
            newValue.put(DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_TYPE, basicVisitsType);
            newValue.put(DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_ID, basicVisitsID);
            newValue.put(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_TYPE, visitsPhotosType);
            newValue.put(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_NAME, visitsPhotosName);
            newValue.put(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_URI, visitsPhotosURI);
            db.insert(DBContract.DB_TABLE_VISITS_PHOTOS, null, newValue);
        }
    }
    ...
    long insertVisitsPhotosNew(Bundle bundle) {
        ...
        newValue.put(DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_TYPE, basicVisitsType);
        newValue.put(DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_ID, basicVisitsID);
        newValue.put(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_TYPE, visitsPhotosType); // из камеры (0) или из галереи (1)
        newValue.put(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_NAME, visitsPhotosName);
        newValue.put(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_URI, visitsPhotosURI);

        return db.insert(DBContract.DB_TABLE_VISITS_PHOTOS, null, newValue);
    }
    ...
    void insertRecordVisitsPhotos(int basicVisitsType, int basicVisitsID, int visitsPhotosType, String visitsPhotosName, String visitsPhotosURI) {
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_TYPE, basicVisitsType);      // визит - основание
        newValue.put(DBContract.TableVisitsPhotos.COLUMN_BASIC_VISITS_ID, basicVisitsID);      // визит - основание
        newValue.put(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_TYPE, visitsPhotosType);      // тип фоторесурса визита из камеры (0) или из галереи (1)
        newValue.put(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_NAME, visitsPhotosName);      // имя фоторесурса визита
        newValue.put(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_URI, visitsPhotosURI);      // путь к фоторесурсу
        db.insert(DBContract.DB_TABLE_VISITS_PHOTOS, null, newValue);
    ...
    public void updateVisitsPhotos(int basicVisitsType, int basicVisitsID, ArrayList<ModelVisitsCures> vphArrayList) {
        ...
        if (cursor.getCount()>0){
            ...
            cursor.moveToFirst();
            do {
                currentID = cursor.getInt(cursor.getColumnIndex(DBContract.TableVisitsPhotos._ID));
                currentURI = cursor.getString(cursor.getColumnIndex(DBContract.TableVisitsPhotos.COLUMN_PHOTOS_URI));
    ...
    public void deleteVisitsPhotos(int basicVisitsType, int basicVisitsID) {
        db.delete(DBContract.DB_TABLE_VISITS_PHOTOS, "basic_visits_type = ? and basic_visits_id = ?", new String[]{Integer.toString(basicVisitsType), Integer.toString(basicVisitsID)});
    }

    // delete visits_photo - одну фотографию по id в таблице DBContract.DB_TABLE_VISITS_PHOTOS
    void deleteVisitsPhotoByID(int recordsID) {
        db.delete(DBContract.DB_TABLE_VISITS_PHOTOS, "_id = ?", new String[]{Integer.toString(recordsID)});
    }
    ...
    Cursor getAllFilters() {
        return db.query(DBContract.DB_TABLE_FILTERS,
                new String[] {DBContract.TableFilters._ID,
                        DBContract.TableFilters.COLUMN_FILTERS_NAME,
                        DBContract.TableFilters.COLUMN_FILTERS_ONLY_WHITH_DATE,
                        DBContract.TableFilters.COLUMN_FILTERS_FIRST_DATE,
                        DBContract.TableFilters.COLUMN_FILTERS_LAST_DATE,
                        DBContract.TableFilters.COLUMN_FILTERS_CLINICS_ID,
                        DBContract.TableFilters.COLUMN_FILTERS_DOCTORS_ID,
                        DBContract.TableFilters.COLUMN_FILTERS_SPECIALIZATIONS_ID,
                        DBContract.TableFilters.COLUMN_FILTERS_CURES_ID,
                        DBContract.TableFilters.COLUMN_FILTERS_DIAGNOSIS_ID,
                        DBContract.TableFilters.COLUMN_FILTERS_ANALISES_TYPES_ID,
                        DBContract.TableFilters.COLUMN_FILTERS_RECOMMENDATIONS_ID},
                null, null, null, null, null);
        //null, null, null, null, "name ASC");
    }
    ...
    Bundle getFiltersFildsByFiltersID(int filtersID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_FILTERS,
                new String[] {DBContract.TableFilters._ID,
                        DBContract.TableFilters.COLUMN_FILTERS_NAME,
                        DBContract.TableFilters.COLUMN_FILTERS_ONLY_WHITH_DATE,
                        DBContract.TableFilters.COLUMN_FILTERS_FIRST_DATE,
        ...
        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            Bundle bundle = new Bundle();
            bundle.putString("filterName", cursor.getString(cursor.getColumnIndex(DBContract.TableFilters.COLUMN_FILTERS_NAME)));
            int onlyWithDate = cursor.getInt(cursor.getColumnIndex(DBContract.TableFilters.COLUMN_FILTERS_ONLY_WHITH_DATE));
            bundle.putBoolean("onlyWithDate", (onlyWithDate == 1));
            Long firstDate = cursor.getLong(cursor.getColumnIndex(DBContract.TableFilters.COLUMN_FILTERS_FIRST_DATE));
            bundle.putLong("firstDate", firstDate);
            Long lastDate = cursor.getLong(cursor.getColumnIndex(DBContract.TableFilters.COLUMN_FILTERS_LAST_DATE));
            bundle.putLong("lastDate", lastDate);
            int clinicsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableFilters.COLUMN_FILTERS_CLINICS_ID));
            bundle.putInt("clinicsID", clinicsID);
            int doctorsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableFilters.COLUMN_FILTERS_DOCTORS_ID));
            bundle.putInt("doctorsID", doctorsID);
            int specializationsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableFilters.COLUMN_FILTERS_SPECIALIZATIONS_ID));
            bundle.putInt("specializationsID", specializationsID);
            int mCuresID = cursor.getInt(cursor.getColumnIndex(DBContract.TableFilters.COLUMN_FILTERS_CURES_ID));
            bundle.putInt("curesID", mCuresID);
            int mDiagnosisID = cursor.getInt(cursor.getColumnIndex(DBContract.TableFilters.COLUMN_FILTERS_DIAGNOSIS_ID));
            bundle.putInt("diagnosisID", mDiagnosisID);
            int mAnalisesTypesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableFilters.COLUMN_FILTERS_ANALISES_TYPES_ID));
            bundle.putInt("analisesTypesID", mAnalisesTypesID);
            int mRecommendationsID = cursor.getInt(cursor.getColumnIndex(DBContract.TableFilters.COLUMN_FILTERS_RECOMMENDATIONS_ID));
    ...
    int getIDFiltersByName(String filterName) {
        int filterID;
        Cursor cursor = db.query(DBContract.DB_TABLE_FILTERS, new String[] {DBContract.TableFilters._ID},
                "name = ?", new String[]{filterName}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            filterID = cursor.getInt(cursor.getColumnIndex(DBContract.TableFilters._ID));
        }else {filterID = 0;}
        cursor.close();
    ...
    int insertFilter(Bundle bundle){
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableFilters.COLUMN_FILTERS_NAME, bundle.getString("filterName"));  // text
        newValue.put(DBContract.TableFilters.COLUMN_FILTERS_ONLY_WHITH_DATE, bundle.getBoolean("onlyWithDate") ? 1 : 0);  // integer (boolen) 0 - 1
        newValue.put(DBContract.TableFilters.COLUMN_FILTERS_FIRST_DATE, bundle.getLong("firstDate"));  // long
        newValue.put(DBContract.TableFilters.COLUMN_FILTERS_LAST_DATE, bundle.getLong("lastDate"));  // long
        newValue.put(DBContract.TableFilters.COLUMN_FILTERS_CLINICS_ID, bundle.getInt("clinicsID"));  // integer
        newValue.put(DBContract.TableFilters.COLUMN_FILTERS_DOCTORS_ID, bundle.getInt("doctorsID"));  // integer
        newValue.put(DBContract.TableFilters.COLUMN_FILTERS_SPECIALIZATIONS_ID, bundle.getInt("specializationsID"));  // integer
        newValue.put(DBContract.TableFilters.COLUMN_FILTERS_CURES_ID, bundle.getInt("curesID"));  // integer
        newValue.put(DBContract.TableFilters.COLUMN_FILTERS_DIAGNOSIS_ID, bundle.getInt("diagnosisID"));  // integer
        newValue.put(DBContract.TableFilters.COLUMN_FILTERS_ANALISES_TYPES_ID, bundle.getInt("analisesTypesID"));  // integer
        newValue.put(DBContract.TableFilters.COLUMN_FILTERS_RECOMMENDATIONS_ID, bundle.getInt("recommendationsID"));  // integer

        return (int) db.insert(DBContract.DB_TABLE_FILTERS, null, newValue);
    }
    ...
    void updateFilter(int chosenID, Bundle bundle){
        ...
        db.update(DBContract.DB_TABLE_FILTERS, newValue, "_id = ?", new String[]{String.valueOf(chosenID)});
    }

    void deleteFilter(int chosenID) {
        db.delete(DBContract.DB_TABLE_FILTERS, "_id = ?", new String[]{String.valueOf(chosenID)});
    }
    ...
    Cursor getAllProfiles() {
        return db.query(DBContract.DB_TABLE_PROFILES,
                new String[] {DBContract.TableProfiles._ID,
                        DBContract.TableProfiles.COLUMN_PROFILES_NAME,
                        DBContract.TableProfiles.COLUMN_PROFILES_SEX,
                        DBContract.TableProfiles.COLUMN_PROFILES_BIRTHDAY,
                        DBContract.TableProfiles.COLUMN_PROFILES_COMMENT},
                null, null, null, null, "name ASC");
    }
    ...
    Cursor getAllVisitsByProfilesID(int profilesID) {
        return db.query(DBContract.DB_TABLE_VISITS,
                new String[] {DBContract.TableVisits._ID,
                        DBContract.TableVisits.COLUMN_VISITS_PROFILE_ID},
                DBContract.TableVisits.COLUMN_VISITS_PROFILE_ID + " = ?", new String[]{String.valueOf(profilesID)}, null, null, null);
    }
    ...
    Cursor getAllAnalisesVisitsByProfilesID(int profilesID) {
        return db.query(DBContract.DB_TABLE_ANALISES_VISITS,
                new String[] {DBContract.TableAnalisesVisits._ID,
                        DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_PROFILE_ID},
                DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_PROFILE_ID + " = ?", new String[]{String.valueOf(profilesID)}, null, null, null);
    }

    // возвращаем ID первого профиля
    int getFirstProfilesID() {
        int firstProfilesID;
        Cursor cursor = db.query(DBContract.DB_TABLE_PROFILES, new String[] {DBContract.TableProfiles._ID},
                null, null, null, null, "_id ASC");

        cursor.moveToFirst();
        firstProfilesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableProfiles._ID));
    ...
    Bundle getProfilesFildsByProfilesID(int profilesID) {
        Cursor cursor = db.query(DBContract.DB_TABLE_PROFILES,
                new String[] {DBContract.TableProfiles._ID,
                        DBContract.TableProfiles.COLUMN_PROFILES_NAME,
                        DBContract.TableProfiles.COLUMN_PROFILES_SEX,
                        DBContract.TableProfiles.COLUMN_PROFILES_BIRTHDAY,
        ...
        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            Bundle bundle = new Bundle();
            String profilesName = cursor.getString(cursor.getColumnIndex(DBContract.TableProfiles.COLUMN_PROFILES_NAME));
            bundle.putString("profilesName", profilesName);
            String profilesSex = cursor.getString(cursor.getColumnIndex(DBContract.TableProfiles.COLUMN_PROFILES_SEX));
            bundle.putString("profilesSex", profilesSex);
            Long profilesBirthday = cursor.getLong(cursor.getColumnIndex(DBContract.TableProfiles.COLUMN_PROFILES_BIRTHDAY));
            bundle.putLong("profilesBirthday", profilesBirthday);
            String profilesComment = cursor.getString(cursor.getColumnIndex(DBContract.TableProfiles.COLUMN_PROFILES_COMMENT));
    ...
    public String getProfilesNameByID(int profilesID) {
        String profilesName;
        Cursor cursor = db.query(DBContract.DB_TABLE_PROFILES, new String[] {DBContract.TableProfiles._ID, DBContract.TableProfiles.COLUMN_PROFILES_NAME},
                "_id = ?", new String[]{String.valueOf(profilesID)}, null, null, null);

        if (cursor.getCount()>0) {
            cursor.moveToFirst();
            profilesName = cursor.getString(cursor.getColumnIndex(DBContract.TableProfiles.COLUMN_PROFILES_NAME));
        }else {
            profilesName = "";
        }
        cursor.close();
    ...
    public int getIDProfilesByName(String profilesName) {
        ...
        if (cursor.getCount()>0){
            cursor.moveToFirst();
            profilesID = cursor.getInt(cursor.getColumnIndex(DBContract.TableProfiles._ID));
        }else profilesID = 0;
        cursor.close();
    ...
    int insertProfiles(Bundle bundle) {
        ...
        ContentValues newValue = new ContentValues();
        newValue.put(DBContract.TableProfiles.COLUMN_PROFILES_NAME, profilesName);
        newValue.put(DBContract.TableProfiles.COLUMN_PROFILES_SEX, profilesSex);
        newValue.put(DBContract.TableProfiles.COLUMN_PROFILES_BIRTHDAY, profilesBirthday);
        newValue.put(DBContract.TableProfiles.COLUMN_PROFILES_COMMENT, profilesComment);
        long curProfileID = db.insert(DBContract.DB_TABLE_PROFILES, null, newValue);
    ...
    void updateProfiles(int choosenID, Bundle bundle) {
        ...
        newValue.put(DBContract.TableProfiles.COLUMN_PROFILES_BIRTHDAY, profilesBirthday);
        newValue.put(DBContract.TableProfiles.COLUMN_PROFILES_COMMENT, profilesComment);
        db.update(DBContract.DB_TABLE_PROFILES, newValue, "_id = ?", new String[]{Integer.toString(choosenID)});
    }

    // delete профиль
    void deleteProfiles(int choosenRecordID) {
        db.delete(DBContract.DB_TABLE_PROFILES, "_id = ?", new String[]{String.valueOf(choosenRecordID)});
    }
...
/*
                // Первоначальное заполнение. Должно получать готовые списки из presenter-а
                ...
                for (String specializations_record : specializations_records) {
                    values.put(DBContract.TableSpecializations.COLUMN_SPECIALIZATIONS_NAME, specializations_record);
                ...
                for (String aSpecializations_recordsCu : specializations_recordsCu) {
                    valuesCu.put(DBContract.TableCures.COLUMN_CURES_NAME, aSpecializations_recordsCu);
                ...
                for (int i = 0; i < lengthDi; i++) {
                    valuesDi.put(DBContract.TableDiagnoses.COLUMN_DIAGNOSES_NAME, diagnoses_recordsDi[i]);
                ...
                for (int i = 0; i < lengthAnT; i++) {
                    valuesAnT.put(DBContract.TableAnalisesTypes.COLUMN_ANALISES_TYPES_NAME, diagnoses_recordsAnT[i]);
                ...
                for (int i = 0; i < lengthRecT; i++) {
                    valuesRecT.put(DBContract.TableRecommendations.COLUMN_RECOMMENDATIONS_NAME, recommendations_recordsRecT[i]);
...
*/
            ...
            case 3:
                ...
                db.execSQL("alter table " + DBContract.DB_TABLE_VISITS + " add column " + DBContract.TableVisits.COLUMN_VISITS_PROFILE_ID + " integer;");
                db.execSQL("alter table " + DBContract.DB_TABLE_ANALISES_VISITS + " add column " + DBContract.TableAnalisesVisits.COLUMN_ANALISES_VISITS_PROFILE_ID + " integer;");
            ...
            case 4:
                ...
                db.execSQL("alter table " + DBContract.DB_TABLE_VISITS_DIRECTIONS + " add column " + DBContract.TableVisitsDirections.COLUMN_AN_TYPES_SPECIALISATIONS_ID + " integer;");
