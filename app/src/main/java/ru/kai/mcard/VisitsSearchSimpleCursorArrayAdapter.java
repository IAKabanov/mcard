...
public class VisitsSearchSimpleCursorArrayAdapter extends SimpleCursorAdapter{
    private Context mContext;
    private LayoutInflater mInflater;
    private List<String> mSourseList = null;
    private ArrayList<String> mArraylist;

    VisitsSearchSimpleCursorArrayAdapter(Context context, int layoutResurceID, Cursor cursor, String[] from, int[] to, int flag){
        super(context, layoutResurceID, cursor, from, to, flag);
