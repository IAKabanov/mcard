...
import ru.kai.mcard.data.datasource.DBContract;
...
public class DatabaseTest{
    ...
    public void create_database_test() throws Exception {
        ...
        assertEquals("Error: Your database was created without the expected tables.",
                DBContract.DB_TABLE_CLINICS, tableNameCursor.getString(0));
    ...
    public void insert_single_record_test() throws Exception {
        ...
        testValues.put(DBContract.TableClinics.COLUMN_CLINICS_NAME, "test clinic name");
        testValues.put(DBContract.TableClinics.COLUMN_CLINICS_DESCR, "test clinic descr");
